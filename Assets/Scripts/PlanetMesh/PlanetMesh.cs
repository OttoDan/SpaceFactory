...
public class PlanetMesh
{
    ...
    private int   m_NumberOfContinents = 5;
    private float m_ContinentSizeMax   = 1.0f;
    private float m_ContinentSizeMin   = 0.1f;

    private int   m_NumberOfHills = 5;
    private float m_HillSizeMax   = 1.0f;
    private float m_HillSizeMin   = 0.1f;
    ...
    public PlanetMesh(int subidivisions = 1, int m_NumberOfContinents = 5, float m_ContinentSizeMax = 1.0f, float m_ContinentSizeMin = 0.1f, int m_NumberOfHills = 5, float m_HillSizeMax = 1.0f, float m_HillSizeMin = 0.1f)
    {
        this.m_NumberOfContinents = m_NumberOfContinents;
        this.m_ContinentSizeMax = m_ContinentSizeMax;
        this.m_ContinentSizeMin = m_ContinentSizeMin;
        this.m_NumberOfHills = m_NumberOfHills;
        this.m_HillSizeMax = m_HillSizeMax;
        this.m_HillSizeMin = m_HillSizeMin;

        // Create an icosahedron, subdivide it three times so that we have plenty of polys
        // to work with.

        InitAsIcosohedron();
        Subdivide(subidivisions);
    ...
    // public void PlaceHexaTiles()
    // {
    //     List<int> verts;
    //     foreach(PolySet poly in p)
    //     {
    //        verts = poly.GetUniqueVertices();
    //        for(int i = 1; i < verts.Count; i++)
    //        {
    //            Vector3 middle = Vector3.Lerp(m_Vertices[verts[i]], m_Vertices[verts[i-1]], 0.5f).normalized;
    //        }
    //     }
    // }
}